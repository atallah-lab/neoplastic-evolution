...
#### L1-cellpop-stochastic.ipynb
* A version of the simulation implemented in L1-cellpop.ipynb that assumes an initially stationary population, incorporates cell death, and focuses on stochastic simulation.

#### L1-cellpop-stochastic.ipynb
* A version of L1-cellpop-stochastic.ipynb that uses a two-hit model of driver and passenger mutations, and tracks disrupted genes for each clone of the population.
